...
public final class TSLexicalEnvironment {
  ...
  private TSLexicalEnvironment(final TSEnvironmentRecord environmentRecord, final TSLexicalEnvironment outerEnvironment) {
  ...
  public TSReference getIdentifierReference(final TSString name) {
    if (environmentRecord.hasBinding(name)) {
      ...
      if (outerEnvironment == null) {
        ...
        // [old] return new TSEnvironmentReference(name, null);
        //System.err.println("outer environment is null");
        //System.err.println("name in lex : " + name );
        return new TSPropertyReference(name,TSEnvironmentRecord.globalObject);
      }
  ...
  public void declareVariable(final TSString name, final boolean configurableBinding) {
  ...
  public static TSLexicalEnvironment newObjectEnvironment(TSGlobalObject globalObject, TSLexicalEnvironment outerEnvironment  ) {
    return new TSLexicalEnvironment(new TSObjectEnvironmentRecord(globalObject),outerEnvironment);
  }
}
